...
void MonitorJuego::inicializar(){
  ...
  for (int i=0; i<nrey; i++){
    ...
    nueva_entidad(new Entidad(npc, rey, sur, xRand, yRand, new Rey3D(""), new ComportamientoPersonaje()));
  }
  ...
  for (int i=0; i<nregalos; i++){
    ...
    nueva_entidad(new Entidad(objeto, regalo, norte, xRand, yRand, new Item3D(), new ComportamientoObjeto()));
  }
